"""Core logic for agent_evaluation_suite."""
...
def analyze_records(records: list[dict[str, Any]]) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        score=score,
        summary=f"{summary} result for: Testing harness for completion rate, hallucination rate, cost efficiency, and edge cases.",
        signals=signals,
    )
