...
## Objective
Maintain `agent-evaluation-suite` as a reliable, useful, and test-first project aligned with its primary promise:
> Testing harness for completion rate, hallucination rate, cost efficiency, and edge cases.
